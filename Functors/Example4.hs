...
main = do
    ...
    putStrLn "Ejemplo 2"
    print $ miFunc <$> obtValCol
    putStrLn ""
    
    putStrLn "Ejemplo 3"
    print $ miFunc <$> obtValColNull
    putStrLn ""
    
    putStrLn "Ejemplo 4"
    print $ fmap miFunc <$> obtValColDb
    putStrLn ""

    putStrLn "Ejemplo 5"
    print $ fmap miFunc <$> obtValColDbNull
    putStrLn ""

    putStrLn "Ejemplo 6"
    print $ fmap miFunc <$> obtValColDbErr
    putStrLn ""

    putStrLn "Ejemplo 7"
    print $ (fmap . fmap) miFunc <$> obtValColDbTbl
    putStrLn ""
